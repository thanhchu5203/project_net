        ...
        */
        ...
        EventApi.prototype.setAllDay = function (allDay, options) {
            ...
            if (maintainDuration == null) {
                maintainDuration = this.db.options.allDayMaintainDuration;
            }
        ...
        Object.defineProperty(EventApi.prototype, "source", {
            get: function () {
                ...
                if (sourceId) {
                    return new EventSourceApi(this.db, this.db.getCurrentData().eventSources[sourceId]);
                }
                return null;
            },
            enumerable: false,
        ...
        Object.defineProperty(EventApi.prototype, "start", {
            get: function () {
                return this._instance ?
                    this.db.dateEnv.toDate(this._instance.range.start) :
                    null;
            },
            enumerable: false,
            configurable: true
        ...
        Object.defineProperty(EventApi.prototype, "end", {
            get: function () {
                return (this._instance && this._def.hasEnd) ?
                    this.db.dateEnv.toDate(this._instance.range.end) :
                    null;
            },
            enumerable: false,
            configurable: true
        ...
        Object.defineProperty(EventApi.prototype, "startStr", {
            get: function () {
                var instance = this._instance;
                if (instance) {
                    return this.db.dateEnv.formatIso(instance.range.start, {
        ...
        Object.defineProperty(EventApi.prototype, "endStr", {
            get: function () {
                ...
                if (instance && this._def.hasEnd) {
                    return this.db.dateEnv.formatIso(instance.range.end, {
                        omitTime: this._def.allDay,
